...
const PLANS = [
  {
    ...
    headerCls: "bg-sky-100 text-sky-800",
  },
  {
    key: "cp",
    label: "CP",
    ...
    headerCls: "bg-violet-100 text-violet-800",
  },
  {
    key: "map",
    label: "MAP",
  ...
  },
  {
    ...
    headerCls: "bg-emerald-100 text-emerald-800",
  },
];
        ...
        <table className="w-full text-xs min-w-[480px]">
          <thead>
            <tr className="bg-slate-50 border-b border-slate-100">
              <th className="text-left px-3 py-2 font-semibold text-slate-400 uppercase tracking-wide w-16">
                Plan
              </th>
              {OCC_TYPES.map((o) => (
                <th
          ...
          <tbody>
            {activePlans.map((plan) => {
              ...
              return (
                <tr
                  key={plan.key}
                  className={`border-t border-slate-100 ${plan.key === "ep" ? "" : ""}`}
                >
                  {/* Plan badge */}
                  <td className="px-3 py-2">
                    <span
                      className={`inline-flex items-center px-2 py-0.5 rounded-md text-[10px] font-black uppercase border ${plan.badgeCls}`}
                    >
                      {plan.label}
                    </span>
                  </td>
                      ...
                      <td key={occ.key} className="px-2 py-1.5 text-center">
                        {isEditing ? (
                          <div className="relative inline-flex items-center">
                            <span className="absolute left-2 text-slate-400 text-[10px] pointer-events-none">
                              ₹
                            </span>
                            <input
                              type="number"
                              ...
                              value={val}
                              onChange={(e) =>
                                setVal(plan.key, occ.key, e.target.value)
                              }
                          ...
                          <span
                            className={`font-semibold ${val === 0 ? "text-slate-300" : "text-slate-700"}`}
                          >
                            {fmt(val)}
                          </span>
                        )}
...
function SeasonCard({
  ...
  return (
    <div
      className={`rounded-xl border overflow-hidden ${hasConflict ? "border-red-200 ring-1 ring-red-100" : "border-slate-200"}`}
    >
      {/* Header */}
      <div
        onClick={() => setOpen((o) => !o)}
          ...
          {hotels && (
            <div className="flex items-center gap-2 flex-wrap justify-end">
              ...
              <Button
                ...
                className="gap-1.5 bg-theme-primary hover:bg-theme-secondary text-white shadow-md text-xs"
                onClick={() =>
          ...
          <div className="space-y-5">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-slate-500 mt-1">
                    ...
                    seasons and meal-plan pricing (Double, Extra Adult, Extra
                    Child, CNB) will be extracted for review.
                  </p>
                </div>
              </div>
            ...
            <div className="bg-white rounded-2xl border border-slate-100 shadow-sm p-5">
                  ...
                  <thead>
                    <tr className="bg-slate-50">
                      {[
                        ...
                        <th
                          key={h}
                          className="px-1.5 py-1.5 text-left font-semibold text-slate-500 border-b border-slate-100 whitespace-nowrap"
                        >
                          {h}
                        </th>
                      ))}
                    ...
                    {[
                      ...
                      >
                        {row.map((cell, j) => (
                          <td
                            key={j}
                            className={`px-1.5 py-1.5 whitespace-nowrap ${!cell ? "text-slate-200" : "text-slate-700"}`}
                          >
                            {cell || "↑"}
                          </td>
                        ))}
              ...
              <p className="text-[10px] text-slate-400 mt-3">
                EA = Extra Adult · EC = Extra Child · CNB = Child No Bed (0-4
                yrs) · Dbl = Double occupancy. Hotel meta columns only need
                filling on the first row per hotel.
              </p>
            </div>
          </div>
        )}
