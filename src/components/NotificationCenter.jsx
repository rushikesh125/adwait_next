...
import {
  ...
  CalendarCheck, XCircle, Users, ExternalLink, Inbox,
} from "lucide-react";
      ...
      <div className="flex items-start gap-2">
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="mt-2 flex gap-2">
            ...
            <button onClick={onDismiss} className="text-[11px] font-medium text-blue-600 hover:underline">
              Not now
            </button>
          </div>
        </div>
        ...
        ">
          ...
          <div className="flex items-center justify-between border-b border-slate-100 px-4 py-3">
            ...
            <div className="flex items-center gap-3">
              ...
              <button
                onClick={() => { setOpen(false); router.push("/agent-panel/notifications"); }}
            ...
            {!isLoading && followUps.length > 0 && (
              <section>
                ...
                {followUps.map((fu) => {
                  ...
                  return (
                    <div key={`fu-${fu.id}`} className="border-b border-slate-50 px-4 py-3 bg-amber-50/20 hover:bg-amber-50/50 transition-colors">
                      <div className="flex items-start gap-3">
                        ...
                        <div className="min-w-0 flex-1">
                          ...
                          {fu.notes && <p className="mt-0.5 text-xs text-slate-400 line-clamp-1">{fu.notes}</p>}
              ...
              <section>
                {followUps.length > 0 && (
                  <div className="sticky top-0 bg-slate-50/90 backdrop-blur-sm px-4 py-2 border-b border-slate-100 z-10">
                    <span className="text-[11px] font-bold uppercase tracking-wider text-slate-500">Recent Activity</span>
                  </div>
                )}
