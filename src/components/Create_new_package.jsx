        ...
        <div className="relative p-5">
          ...
          <div className="grid grid-cols-3 gap-3">
            ...
            <div className="bg-white/80 rounded-xl p-3 border border-white shadow-sm">
              ...
              <p className="font-black text-theme-primary text-base">₹{Number(totalPrice || 0).toLocaleString("en-IN")}</p>
            </div>
          </div>
        </div>
      </div>
...
const transportTotalPrice = (() => {
  if (!selectedTransport?.selectedVehicle) {
    console.log("🚫 No transport selected");
    return 0;
  }
  ...
  console.log("Total Days (N+1):", days);
  console.log("Minimum KM Per Day:", minKm);
  console.log("Per KM Price:", perKm);
  console.log("Lumpsum Price:", lumpsum);
  console.log("Driver Allowance Per Day:", allowance);

  // 🔹 PER KM Pricing
  if (perKm > 0) {
    const kmCost = minKm * perKm * days;
    const allowanceCost = allowance * days;
    const total = kmCost + allowanceCost;

    console.log("---- PER KM CALCULATION ----");
    console.log("KM Cost:", minKm, "*", perKm, "*", days, "=", kmCost);
    console.log("Allowance Cost:", allowance, "*", days, "=", allowanceCost);
  ...
  // 🔹 LUMPSUM Pricing
  if (lumpsum > 0) {
    const baseCost = lumpsum * days;
    const allowanceCost = allowance * days;
    const total = baseCost + allowanceCost;

    console.log("---- LUMPSUM CALCULATION ----");
    console.log("Base Cost:", lumpsum, "*", days, "=", baseCost);
    console.log("Allowance Cost:", allowance, "*", days, "=", allowanceCost);
    console.log("FINAL TRANSPORT TOTAL:", total);
    console.log("====================================================");
  ...
  console.log("⚠️ No pricing found. Returning 0.");
  console.log("====================================================");
